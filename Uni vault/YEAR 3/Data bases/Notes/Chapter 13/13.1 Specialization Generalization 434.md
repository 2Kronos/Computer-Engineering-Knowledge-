...
```mermaid
gantt
    title Figure 3: Project Schedule Gantt Chart
    dateFormat  YYYY-MM-DD
    axisFormat %b %d
    section Planning & Research
    Literature Review     :crit, 2025-03-01, 14d
    Component Sourcing    :2025-03-15, 14d
    section Hardware Construction
    Glove Subsystem Build :crit, 2025-04-01, 21d
    Arm Subsystem Build   :crit, 2025-04-22, 28d
    section Software Development
    Module Coding         :crit, 2025-05-01, 21d
    Module Integration    :crit, 2025-05-22, 28d
    section System Integration
    Subsystem Combination :crit, 2025-06-01, 21d
    Calibration & Mapping :2025-06-22, 28d
    Preliminary Testing   :2025-07-20, 40d
    section Optimization
    Performance Tuning    :2025-09-01, 14d
    section Final Preparation
    Final Testing         :crit, 2025-09-15, 21d
    Documentation & Video :2025-10-06, 14d
```
